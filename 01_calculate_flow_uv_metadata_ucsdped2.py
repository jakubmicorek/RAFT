...
root_folder_ucsdped2 = "/mnt/data/anomaly_detection_datasets_preprocessed/ucsd"

root_folder_ucsdped2_data_test_flow = os.path.join(root_folder_ucsdped2, "UCSDped2_flow/Test")
root_folder_ucsdped2_data_train_flow = os.path.join(root_folder_ucsdped2, "UCSDped2_flow/Train")
...
for current_root_folder in [root_folder_ucsdped2_data_train_flow, root_folder_ucsdped2_data_test_flow]:
